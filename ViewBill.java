...
public class ViewBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill ID", "Bill Date", "Med ID", "Med Name", "Total Paid", "Generated By", "No of Units"
            }
        ));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM purchase_medicine");
            while (rs.next()) {
            model.addRow(new Object[]{rs.getString("billid"),rs.getString("billdate"),rs.getString("medid"),
            rs.getString("name"),rs.getString("totalpaid"),rs.getString("generatedBy"),rs.getString("noofunits")});
            }
